...
export type AuditEntry = {
  id: string;
  entityType: "player" | "match" | "special_event" | "snapshot";
  entityId: string;
...
export type MahjongState = { players: Player[]; matches: Match[]; specialEvents: SpecialEvent[]; snapshots: Snapshot[]; audit: AuditEntry[]; demo: boolean };
export type RankingRow = { playerId: string; name: string; score: number; games: number; tier: "A" | "B" | "C" | "D" };
